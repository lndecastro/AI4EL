...
## Part III — Reflection and Wrap-Up

### 3.1 What All These Examples Have in Common
...
### 3.4 What Is Coming in Class 2

In the next class, we will move from understanding AI to using it for the tasks most common in daily and professional life:
...
By the end of Class 2, you will have used AI to complete real tasks you face every week — and you will have a personal prompt library to take with you.
...
- [ ] Write a prompt using at least three of the four ingredients (Role, Context, Task, Format).
- [ ] Reflect on one thing AI did well and one thing it got wrong in your hands-on activity.
