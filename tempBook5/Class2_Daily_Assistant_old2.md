...
## Part IV — AI for Your Career: Professional Pages, CVs, Cover Letters, and Interviews
...
### 4.1 How to Export Your LinkedIn Profile as a PDF
...
### 4.2 Activity 4: Create Your Personal Professional Page
...
**Step 1 — Export your LinkedIn PDF** (see Section 4.1 above)
...
### 4.3 Activity 5: Tailor Your CV and Write a Cover Letter for a Specific Job
...
**Step 1 — Export your LinkedIn PDF** (see Section 4.1 if you have not already done so)
...
### 4.4 Activity 6: Prepare for Your Interview
...
Both approaches use the same materials you already have from Activities 4 and 5: your CV and the job posting.
...
- Your LinkedIn PDF (exported in Section 4.1) or CV
...
## Part V — Your Prompt Library: Consolidating What You've Learned

You have now worked through the full range of tasks covered in this class: prompt literacy, email and document communication, spreadsheet analysis, and career materials. Before we close, it is time to consolidate that work into something you will actually keep using.
...
### 5.2 Activity 7: Build Your Prompt Library Starter
