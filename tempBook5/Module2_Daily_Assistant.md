...
In Module 1, you learned what AI is, how it works, and how to communicate with it effectively, from writing your first prompts to choosing the right prompt patterns and engineering context for better results. Now it is time to put those skills to work on the tasks that fill most people's professional and personal lives: writing and responding to emails, making sense of long documents, navigating spreadsheet data without needing to be a data expert, tailoring your CV to a specific job opportunity, writing a cover letter, and creating a personal page.

By the end of this module, you will have used AI to complete tasks you face frequently, and you will walk away with a personal **Prompt Library** of tested, ready-to-use templates.

> **The central idea of this module:** AI is not a magic button. It is a skilled assistant that responds to how clearly you communicate. The better you get at expressing your needs, the more value AI delivers.

## Learning Objectives

By the end of this module, you will be able to:

1. Use AI to draft, rewrite, summarize, and improve emails for different purposes and audiences.
2. Use AI to summarize long documents, reports, and articles quickly and accurately.
3. Use AI as a search assistant to find flights, local services, and real-world information.
4. Use multimodal AI to have a real-time conversation using images from your phone or screen.
...
## Part I — AI for Emails and Written Communication
...
### 1.2 Prompt Templates for Common Email Tasks
...
### 1.3 Activity 1: Draft a Real Email
...
### 1.4 AI Tools for Email Management
...
### 1.5 AI for Documents: Reading, Summarizing, and Creating
...
### 2.1 AI Search vs. Traditional Search: What Is the Difference?
...
### 2.3 Prompt Templates for Everyday Search Tasks
...
### 2.4 Practical Search Scenarios
...
### 2.6 Activity 3: Search for Something Real
...
### 3.4 Phase 2 — Build the Skeleton
...
### 3.5 Phase 3 — Fill In the Details
...
### 3.6 Phase 4 — Personalize and Enrich
...
### 3.7 Phase 5 — Challenge the Plan
...
### 3.8 Phase 6 — Generate a Shareable Artefact
...
### 4.1 Activity 4: What's for Dinner?

**Tool:** [Google AI Studio Live](https://aistudio.google.com/live)
**Time:** ~20 minutes
...
You have two options for showing the AI your ingredients. Choose whichever works best for you:
...
**Option B — Use your phone camera (recommended for phones and tablets)**

1. Gather a small collection of ingredients somewhere in front of you (on a table, countertop, or bag of groceries).
2. You will hold your phone camera up to show the ingredients during the activity.

#### Step-by-Step Instructions

**Step 1 — Open Google AI Studio Live**

Go to [aistudio.google.com/live](https://aistudio.google.com/live) in your browser. If prompted, sign in with a Google account (a free Gmail account works fine).

You will see a live chat interface. This is where you will interact with the AI.

**Step 2 — Share your ingredients with the AI**

Depending on your option:

- *Option A (screen share):* Click the **Share screen** or **camera** icon in AI Studio Live and select the window or tab where your ingredient photo is visible.
- *Option B (phone camera):* Tap the **camera** icon and point your phone at the ingredients so the AI can see them clearly.

Give the AI a moment to process what it sees.
...
- *"How long will this take to cook? I only have about 30 minutes."*
- *"Is this a healthy meal? How could I make it a bit lighter?"*
- *"Can I make this for four people? What quantities would I need?"*
- *"What should I serve this with?"*

Feel free to keep the conversation going in whatever direction feels natural to you.
...
1. How accurately did the AI identify your ingredients? Did it miss anything or get something wrong?
2. Were the recipe suggestions practical and realistic for you? Why or why not?
3. How did the conversation feel compared to searching for a recipe online?
...
By the end of Part V, you will be able to ask AI to build a spreadsheet for you, populate it with real-life numbers, generate a plain-language financial summary, analyze any table of data, and write formulas without knowing a single line of syntax.
No spreadsheet experience required.

### 5.1 Build Your Personal Finance Tracker with AI
...
### 5.3 Two Ways to Use AI with Spreadsheet Data
...
### 5.4 Prompt Templates for Spreadsheet Tasks
...
### 5.5 Activity: AI Meets Your Spreadsheet
...
### 6.1 How to Export Your LinkedIn Profile as a PDF
...
### 6.2 Activity 5: Create Your Personal Professional Page
...
**Step 1 — Export your LinkedIn PDF** (see Section 6.1 above)
...
### 6.3 Activity 6: Tailor Your CV and Write a Cover Letter for a Specific Job
...
**Step 1 — Export your LinkedIn PDF** (see Section 6.1 if you have not already done so)
...
### 6.4 Activity 7: Prepare for Your Interview
...
- Your LinkedIn PDF (exported in Section 6.1) or CV
...
## Part VII — Your Prompt Library: Consolidating What You've Learned

You have now worked through the full range of tasks covered in this module: prompt literacy, email and document communication, everyday search, spreadsheet analysis, and career materials. Before we close, it is time to consolidate that work into something you will actually keep using.
...
### 7.2 Activity 8: Build Your Prompt Library Starter

**Goal:** Leave this module with at least three tested, personally useful prompts.
...
**Step 2:** For each task, write a prompt using the templates from this module or your own approach.
...
## Part VIII — Reflection and Wrap-Up

### 8.1 The Verification-First Mindset
...
### 8.3 What Is Coming in Module 3

In our next module, we step into the creative side of AI. You will:
...
- **Prompt Engineering Guide. (2024).** promptingguide.ai — a free, comprehensive reference for all prompt patterns covered in this module.
...
```{note}
*Module 2 is part of the AI for Everyday Life Program, offered by the Dendritic Institute for Human-Centered AI & Data Science at Florida Gulf Coast University. All hands-on activities can be completed using free AI tools. No spreadsheet expertise or technical background is required.*
```
