...
6. Use multimodal AI to have a real-time conversation using images from your phone or screen.
7. Ask AI to explain, analyze, and simplify spreadsheet data without writing a single formula.
8. Evaluate AI-generated written content critically before using or sharing it.
9. Build a reusable personal Prompt Library for daily communication tasks.
...
## Worked Example — Planning a Family Trip with AI

This worked example brings together everything covered so far in this class — context engineering, multi-turn conversations, iterative refinement, and real-world search — and applies them to one of the most complex planning tasks many families face: a multi-generational trip abroad.
...
### 4.1 Activity 5: What's for Dinner?
...
### 6.2 Activity 6: Create Your Personal Professional Page
...
### 6.3 Activity 7: Tailor Your CV and Write a Cover Letter for a Specific Job
...
### 6.4 Activity 8: Prepare for Your Interview
...
### 7.2 Activity 9: Build Your Prompt Library Starter
